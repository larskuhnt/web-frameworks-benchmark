...
The original source code for running these benchmarks is attributed to oleganza[http://github.com/oleganza/web-frameworks-benchmark].
The code was heavily adapted and modern versions of each popular ruby web framework were included along with developing three different benchmark tests for additional accuracy. 
These modifications were made by DAddYE[http://github.com/DAddYE] and Nathan Esquenazi[http://github.com/nesquena] for use in benchmarking Padrino.